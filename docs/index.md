...
ax = yab.plot_cortical(data=dmap1, atlas=atlas, vminmax=[-0.1, 0.3], 
...
ax = yab.plot_vertexwise(lh_mesh, rh_mesh, cmap='viridis', vminmax=[-4, 9], 
...
ax = yab.plot_tracts(data=data, atlas=atlas, style='matte',
